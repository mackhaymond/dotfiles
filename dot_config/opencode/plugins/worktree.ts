...
/**
 * Parse the small JSONC config file without requiring OCX-managed dependencies.
 * Handles line/block comments and trailing commas while preserving comment-like
 * text inside strings.
 */
